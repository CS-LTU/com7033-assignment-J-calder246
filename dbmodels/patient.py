...
#Defining patient
class Patient:
    def __init__ (self, _id, id, gender, age, hypertension, bmi, work_type, ever_married, Residence_type, avg_glucose_level, smoking_status, stroke):
        self._id = _id
        self.id = id
        self.gender = gender
        self.age = age
...
#Saving patient (to database not medically)
def save(self):
    patient_data = {
        "_id": self._id,
        "id": self.id,
